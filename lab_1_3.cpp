...
void stock_test() {
    vector<Stock> stocks_array; ///Создание массива
    Stock a("a", 2), b("b", 2), c("c", 2), d("d", 2), e("e", 2); ///Создание объектов класса
    stocks_array.push_back(a);  ///Помещение их в массив
    stocks_array.push_back(b);
    stocks_array.push_back(c);
    stocks_array.push_back(d);
    stocks_array.push_back(e);
    stocks_array[0].Buy(2); ///Покупка акций для компании a(для первого элемента в массиве)
